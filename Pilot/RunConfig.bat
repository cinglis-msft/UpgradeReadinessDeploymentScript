...
:: This data will be used to populate the script run details in the "Where is my Data" report in OMS portal
...
set powershellCommand="&{&'%sourceWithoutQuotes%ConfigScript.ps1' %runMode% '%logPath%' %commercialIDValue% %logMode% %AllowIEData% %IEOptInLevel% %DeviceNameOptIn% %AppInsightsOptIn% %NoOfAppraiserRetries% %ClientProxy% %HKCUProxyEnable% %HKCUProxyServer%; exit $LASTEXITCODE}"

...
set powershellCommand="&{&'%sourceWithoutQuotes%ConfigScript.ps1' %runMode% '%logPath%' %commercialIDValue% %logMode% %AllowIEData% %IEOptInLevel% %DeviceNameOptIn% %AppInsightsOptIn% %NoOfAppraiserRetries% %ClientProxy%; exit $LASTEXITCODE}"
